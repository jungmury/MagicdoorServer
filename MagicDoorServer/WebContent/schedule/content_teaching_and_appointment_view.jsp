		...
		<table width="80%" border="1">
			...
			<tr align="center">
				...
				<td colspan="4"><a class="button" href="initial_main_frame.jsp"
					...
					<a class="button"
					href="ConfirmTeachingAndAppointmentRequest.action?refValue=<%=appointment.refValue%>"
					type="button" onclick="return confirmConfirm();">Confirm
						Request</a>
					<%} %>&nbsp;&nbsp;&nbsp;&nbsp; 
					
					<a class="button"
					href="RejectTeachingAndAppointmentRequest.action?refValue=<%=appointment.refValue%>"
