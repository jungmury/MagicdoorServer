...
<body>
	...
	<center>
		...
		<table width="80%" border="1">
			...
			<tr>
				<!--  -->
				<td colspan="4" align="center"><a class="button" href="initial_main_frame.jsp"
					type="button" target="mainFrame">Main Page</a>&nbsp;&nbsp;&nbsp;&nbsp;
					<%
						if (!message.status.equals("replied")) {
					%> <a class="button"
					href="ReplySelectedMessage.action?msgNo=<%=message.msgNo%>"
					type="button">Reply</a>&nbsp;&nbsp;&nbsp;&nbsp; <%
 						}
 					%>
					&nbsp;&nbsp;&nbsp;&nbsp; <a class="button"
