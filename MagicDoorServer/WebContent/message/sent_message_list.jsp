...
<body background="image/background.png">
	...
	<table width="80%">
		<tr>
			<td align="center">There are no sent messages</td>
		</tr>
	</table>
	<%
		} else {
	...
	<table border="1" width="80%" align="center">
		<tr>
			<td align="center" width="300"><b>Sent Date</b></td>
			<td align="center" width="300"><b>Sent To</b></td>
		</tr>
		<%
		...
		<tr>
			...
			<td align="center"><a
				href="GetSelectedSentMessage.action?msgNo=<%=message.msgNo%>"><%=message.name%></a></td>
		</tr>
		<%
			}
		%>
