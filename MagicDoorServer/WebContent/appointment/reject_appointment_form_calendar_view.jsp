...
<body>
	...
	<center>
		...
		%>
		<form action="RejectAppointmentRequestProCalendarView.action" target="mainFrame"
			...
			<table width="80%" border="1">
				...
				<tr>
					...
					<%
						if (appointment.status.equals("requested")) {
							String status = "To be determined";
					%>
				...
				<tr>
					<td align="center" width="400">Reason</td>
					<td align="center" width="4000" colspan="3"><textarea
							style="width: 96%" name="note"></textarea></td>
				</tr>
				...
				<tr>
					...
					<a class="button"
						...
						value="Do Not Confirm Request">&nbsp;&nbsp;&nbsp;&nbsp;
						
						 <a
						class="button"
						href="GetAppointmentContentCalendarView.action?refValue=<%=appointment.refValue%>"
						type="button">Back to Detail</a> &nbsp;&nbsp;&nbsp;&nbsp;</td>
				</tr>
			</table>
			<input type="hidden" name="refValue" value=<%=appointment.refValue%>>
