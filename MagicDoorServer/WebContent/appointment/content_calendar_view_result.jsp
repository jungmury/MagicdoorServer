...
<body>
	...
	<center>
		...
		%>
		<form action="RejectAppointmentRequestPro.action" target="mainFrame"
			...
			<table width="80%" border="1">
				...
				<tr>
					<td align="center" width="400">Note</td>
					<td align="left" width="4000" colspan="3"><%=appointment.note%></td>
				</tr>
				...
				<tr>
					...
					<td colspan="4"><a class="button"
						href="initial_main_frame.jsp" type="button" target="mainFrame">Main
							Page</a>&nbsp;&nbsp;&nbsp;&nbsp; <input type="hidden" name="refValue"
						value=<%=appointment.refValue%>> &nbsp;&nbsp;&nbsp;&nbsp;

						<a class="button"
						href="GetAppointmentCalendarView.action?userName=<%=userInfo.getUserName()%>"
						type="button">Back to Calendar</a> &nbsp;&nbsp;&nbsp;&nbsp;</td>
				</tr>
			</table>
		</form>
	</center>
