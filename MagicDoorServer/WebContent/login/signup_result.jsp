...
<body>
	...
	<script type="text/javascript">
		setTimeout(function() {
			alert("Registraion Failure. Try Again!");
		}, 0); //will call the function after 2 secs.
	</script>
	<script type="text/javascript">
		setTimeout(function() {
			parent.topFrame.location.href = "../top_menu.jsp"; //will redirect to your blog page (an ex: blog.html)
			parent.mainFrame.location.href = "signup.jsp";
