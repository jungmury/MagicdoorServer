...
import jy.kim.lancs.magicdoor.schedule.service.DeleteTimetableFromScheduleService;
...
public class DeleteTimetableTeachingAndAppointmentAction implements Action {
	...
	public ActionForward excute(HttpServletRequest request,
		...
		DeleteTimetableFromScheduleService service = new DeleteTimetableFromScheduleService();
				...
				if (timeTable != null) {
					for (TimeTableBean t : timeTable) {
						...
						for (int i = -4; i < 5; i++) {
							...
							calendarForTime
									.set(Calendar.HOUR_OF_DAY, calendarForTime
											.get(Calendar.HOUR_OF_DAY) + 1);

							d.setHours(calendarForTime
