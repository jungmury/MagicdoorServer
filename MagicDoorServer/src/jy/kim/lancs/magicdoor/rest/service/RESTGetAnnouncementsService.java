...
public class RESTGetAnnouncementsService {

	public ArrayList<AnnouncementRespBean> getAnnouncementsForTheTagOwner(
			String tagOwner) {
		// TODO Auto-generated method stub
		Connection con = getConnection();
		RESTMagicDoorDao dbPro = new RESTMagicDoorDao(con);

		ArrayList<AnnouncementRespBean> bean = dbPro
				.selectAnnouncementsFor(tagOwner);
