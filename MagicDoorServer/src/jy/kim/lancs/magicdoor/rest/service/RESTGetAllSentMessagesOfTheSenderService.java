...
public class RESTGetAllSentMessagesOfTheSenderService {

	public ArrayList<MessageBean> getAllSentMessages(String sender) {
		// TODO Auto-generated method stub
		Connection con = getConnection();
		RESTMagicDoorDao dbPro = new RESTMagicDoorDao(con);

		ArrayList<MessageBean> bean = dbPro
				.selectAllSentMessagesOfSender(sender);
