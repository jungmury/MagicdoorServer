...
public class RESTPutAnnouncementService {

	public boolean updateNewAnnouncement(AnnouncementReqBean announcement) {
		// TODO Auto-generated method stub
		Connection con = getConnection();
		RESTMagicDoorDao dbPro = new RESTMagicDoorDao(con);

		boolean result = dbPro.updateAnnouncement(announcement);
