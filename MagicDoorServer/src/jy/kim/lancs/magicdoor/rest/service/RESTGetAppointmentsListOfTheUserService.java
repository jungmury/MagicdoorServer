...
public class RESTGetAppointmentsListOfTheUserService {
	public ArrayList<AppointmentRespDetailBean> selectAppointmentStatusOf(
			String userName) {
		// TODO Auto-generated method stub
		Connection con = getConnection();
		RESTMagicDoorDao dbPro = new RESTMagicDoorDao(con);

		ArrayList<AppointmentRespDetailBean> bean = dbPro
				.selectAllAppointmentsForStudentUser(userName);
