...
public class RESTGetAllSentMessagesOfTheReceiverService {

	public ArrayList<MessageBean> getAllSentMessages(String receiver) {
		// TODO Auto-generated method stub
		Connection con = getConnection();
		RESTMagicDoorDao dbPro = new RESTMagicDoorDao(con);

		ArrayList<MessageBean> bean = dbPro
				.selectAllSentMessagesOfReceiver(receiver);
