...
public class RESTGETAppointmentsOfTheLecturerUserInTheWeekService {

	public ArrayList<AppointmentRespDetailBean> getAppointmentsOfTheTagOwnerInTheGivenWeek(
			QueryForAppointments query) {
		// TODO Auto-generated method stub
		Connection con = getConnection();
		RESTMagicDoorDao dbPro = new RESTMagicDoorDao(con);

		ArrayList<AppointmentRespDetailBean> bean = dbPro.selectNotRejectedAppointmentsOfTheLecturerUserInTheWeek(query);
