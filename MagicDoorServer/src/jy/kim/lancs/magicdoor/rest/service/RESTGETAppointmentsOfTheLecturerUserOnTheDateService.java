...
public class RESTGETAppointmentsOfTheLecturerUserOnTheDateService {

	public ArrayList<AppointmentRespDetailBean> getAppointmentsOfTheLecturerUserOnTheDate(
			QueryForAppointments query) {
		// TODO Auto-generated method stub
		Connection con = getConnection();
		RESTMagicDoorDao dbPro = new RESTMagicDoorDao(con);

		ArrayList<AppointmentRespDetailBean> bean = dbPro.selectAppointmentsOfTheLecturerUserOnTheDate(query);
