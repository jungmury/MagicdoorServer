...
import jy.kim.lancs.magicdoor.rest.service.RESTGETAppointmentsOfTheLecturerUserInTheMonthService;
...
public class RESTGETAppointmentsOfTheLecturerUserInTheMonthAction implements
		ActionForRESTWS {
	@Override
	public String excute(String... params) {
		...
		RESTGETAppointmentsOfTheLecturerUserInTheMonthService service = new RESTGETAppointmentsOfTheLecturerUserInTheMonthService();
		...
		temp = service.getAppointmentsOfTheTagOwnerInTheGivenMonth(query);
