...
import jy.kim.lancs.magicdoor.rest.service.RESTGETAppointmentsOfTheLecturerUserInTheWeekService;
...
public class RESTGETAppointmentsOfTheLecturerUserInTheWeekAction implements
		ActionForRESTWS {
	@Override
	public String excute(String... params) {
		...
		RESTGETAppointmentsOfTheLecturerUserInTheWeekService service = new RESTGETAppointmentsOfTheLecturerUserInTheWeekService();
		...
		temp = service.getAppointmentsOfTheTagOwnerInTheGivenWeek(query);
