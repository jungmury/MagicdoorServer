...
import jy.kim.lancs.magicdoor.rest.service.RESTGetWebServiceService;

public class RESTGetWebServiceAction implements ActionForRESTWS {
	...
	public String excute(String... params) {
		...
		RESTGetWebServiceService reqWebSvc = new RESTGetWebServiceService();
