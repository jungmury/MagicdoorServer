...
import jy.kim.lancs.magicdoor.rest.service.RESTGetAllSentMessagesOfTheReceiverService;

public class RESTGetAllSentMessagesOfTheReceiverAction implements ActionForRESTWS{
	...
	public String excute(String... params) {
		...
		RESTGetAllSentMessagesOfTheReceiverService service = new RESTGetAllSentMessagesOfTheReceiverService();
