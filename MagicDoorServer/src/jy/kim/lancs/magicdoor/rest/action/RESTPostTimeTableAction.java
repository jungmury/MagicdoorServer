...
import jy.kim.lancs.magicdoor.rest.service.RESTPostTimeTableService;
...
public class RESTPostTimeTableAction implements ActionForRESTWS {
	...
	public String excute(String... params) {
		...
		RESTPostTimeTableService service = new RESTPostTimeTableService();
		...
		if (params[0] != null) {
			...
			if (service.addTimeTable(timeTableInfo)) {
