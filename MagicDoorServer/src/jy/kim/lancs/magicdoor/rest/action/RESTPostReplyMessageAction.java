...
import jy.kim.lancs.magicdoor.rest.service.RESTPostReplyMessageService;
...
public class RESTPostReplyMessageAction implements ActionForRESTWS {
	...
	public String excute(String... params) {
		...
		RESTPostReplyMessageService service = new RESTPostReplyMessageService();
		...
		temp = service.replyMessage(message);
